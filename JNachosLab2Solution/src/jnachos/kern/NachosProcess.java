...
public class NachosProcess implements Runnable {
	...
	static List <Integer> processIdList = new ArrayList<Integer>();
	static HashMap <Integer, NachosProcess> allProcesses = new HashMap<Integer, NachosProcess>();
	...
	public void savingRegisters(int num_of_registers, int saveVal)
	{
		if(num_of_registers>=0 && num_of_registers<Machine.NumTotalRegs )
		{
			mUserRegisters[num_of_registers] = saveVal;
		}
	}
	...
	public static NachosProcess getNachosProcess(int id)
	{
